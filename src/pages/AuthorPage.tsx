    ...
    <>
      ...
      <main className="max-h-min max-w-3xl mx-auto my-12">
        <div className="flex gap-6">
          <img className="cursor-pointer rounded-full w-48 h-48 shadow transition-all duration-300 hover:shadow-lg hover:scale-105" src="https://media.discordapp.net/attachments/1207509084367102042/1211193520333791242/BLEACHJET.jpg?ex=65ed4ede&is=65dad9de&hm=ab1cb5bdec70ec582454af0c0eb004994ea842c37d06616e001bfbe765e22017&=&format=webp&width=458&height=458" alt="Author profile image" />
          <div>
            ...
            <p className="mt-4 text-justify">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ratione vero dolore ipsam temporibus eaque voluptates ex. Doloremque maiores commodi cum perferendis aliquid ducimus consectetur, dolores, quisquam officiis, provident eum ratione!</p>
          </div>
        </div>
